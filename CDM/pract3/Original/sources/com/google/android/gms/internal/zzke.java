...
public interface zzke extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzke {
        ...
        private static class C0103zza implements zzke {
        ...
        public static zzke zzaB(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzke)) ? new C0103zza(iBinder) : (zzke) queryLocalInterface;
        }
