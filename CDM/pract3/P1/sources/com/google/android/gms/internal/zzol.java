...
public interface zzol extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzol {
        ...
        private static class C0131zza implements zzol {
        ...
        public static zzol zzcX(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzol)) ? new C0131zza(iBinder) : (zzol) queryLocalInterface;
        }
