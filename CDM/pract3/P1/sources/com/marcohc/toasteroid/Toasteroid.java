...
public class Toasteroid {
    ...
    public static void show(Activity activity, String message, STYLES style, int duration, int gravity) {
        ...
        ((GradientDrawable) ((ViewGroup) toastView.findViewById(R.id.toastContainer)).getBackground()).setColor(activity.getResources().getColor(getStyleBackgroundColor(style)));
