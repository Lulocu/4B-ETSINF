                ...
                while (i2 < arrayList3.size()) {
                    ...
                    if (!receiverRecord.broadcasting) {
                        ...
                        if (match >= 0) {
                            ...
                            switch (match) {
                                case FontsContractCompat.FontRequestCallback.FAIL_REASON_SECURITY_VIOLATION /*{ENCODED_INT: -4}*/:
                                    str3 = "category";
                                    break;
                                case FontsContractCompat.FontRequestCallback.FAIL_REASON_FONT_LOAD_ERROR /*{ENCODED_INT: -3}*/:
                                    str3 = "action";
                                    break;
                                case -2:
                                    str3 = "data";
