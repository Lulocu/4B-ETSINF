...
public class Analyzer {
    ...
    private static int getMaxDimensionTraversal(ConstraintWidget constraintWidget, int i, boolean z, int i2) {
        ...
        int i16 = i15 + margin;
        int width = (i == 0 ? constraintWidget.getWidth() : constraintWidget.getHeight()) * i8;
        Iterator it = constraintWidget.mListAnchors[i4].getResolutionNode().dependents.iterator();
        while (it.hasNext()) {
            i14 = Math.max(i14, getMaxDimensionTraversal(((ResolutionAnchor) ((ResolutionNode) it.next())).myAnchor.mOwner, i, z, i16));
        }
        int i17 = 0;
        for (Iterator it2 = constraintWidget.mListAnchors[i7].getResolutionNode().dependents.iterator(); it2.hasNext(); it2 = it2) {
            i17 = Math.max(i17, getMaxDimensionTraversal(((ResolutionAnchor) ((ResolutionNode) it2.next())).myAnchor.mOwner, i, z, width + i16));
        }
        if (z2) {
            i14 -= i6;
            i9 = i17 + i5;
            ...
            i9 = i17 + ((i == 0 ? constraintWidget.getWidth() : constraintWidget.getHeight()) * i8);
            i10 = 1;
        }
        if (i == i10) {
            ...
            while (it3.hasNext()) {
                ...
                if (i8 == i10) {
                    i18 = Math.max(i18, getMaxDimensionTraversal(resolutionAnchor.myAnchor.mOwner, i, z, i6 + i16));
                    i13 = i7;
                } else {
                    i13 = i7;
                    i18 = Math.max(i18, getMaxDimensionTraversal(resolutionAnchor.myAnchor.mOwner, i, z, (i5 * i8) + i16));
                }
                it3 = it3;
                i7 = i13;
                i10 = 1;
            ...
            i11 = i7;
            i12 = (constraintWidget.mBaseline.getResolutionNode().dependents.size() <= 0 || z2) ? i18 : i8 == 1 ? i18 + i6 : i18 - i5;
        } else {
            i11 = i7;
            i12 = 0;
        }
        int max = margin + Math.max(i14, Math.max(i9, i12));
        int i19 = i16 + width;
        if (i8 == -1) {
            i16 = i19;
            i19 = i16;
        ...
        if (z) {
            ...
            constraintWidget.setFrame(i16, i19, i);
        } else {
        ...
        if (constraintWidget.mListAnchors[i4].mTarget != null && constraintWidget.mListAnchors[i11].mTarget != null && constraintWidget.mListAnchors[i4].mTarget.mOwner == (parent = constraintWidget.getParent()) && constraintWidget.mListAnchors[i11].mTarget.mOwner == parent) {
            constraintWidget.mBelongingGroup.addWidgetsToSet(constraintWidget, i);
        }
        return max;
    }
