        ...
        if (this.state != 1 && this.type != 4) {
            ...
            if (this.type == 1 && ((resolutionAnchor7 = this.target) == null || resolutionAnchor7.state == 1)) {
                ...
                if (z) {
                    ...
                    resolutionAnchor10.resolvedOffset = resolutionAnchor10.target.resolvedOffset + f5 + (f6 * f2);
                    ...
                    resolutionAnchor11.resolvedOffset = (resolutionAnchor11.target.resolvedOffset - f5) - (f6 * (1.0f - f2));
                }
                didResolve();
