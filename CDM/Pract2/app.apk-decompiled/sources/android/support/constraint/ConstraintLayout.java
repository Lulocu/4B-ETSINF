    ...
    public void onMeasure(int i, int i2) {
        ...
        if ((this.mOptimizationLevel & 32) == 32) {
            ...
            if (!this.mLayoutWidget.mVerticalWrapOptimized || this.mLayoutWidget.mWrapFixedHeight <= size2) {
                ...
                List<ConstraintWidgetGroup> list = this.mLayoutWidget.mWidgetGroups;
                z2 = USE_CONSTRAINTS_HELPER;
                Analyzer.setPosition(list, 1, size2);
            }
        } else {
            z2 = USE_CONSTRAINTS_HELPER;
        }
                ...
                if (view == null) {
                    ...
                    if (layoutParams.isHelper) {
                        ...
                        if (view.getVisibility() == 8) {
                            i6 = i11;
                        } else if (!z7 || !constraintWidget.getResolutionWidth().isResolved() || !constraintWidget.getResolutionHeight().isResolved()) {
                            ...
                            if (layoutParams.height != -2 || !layoutParams.verticalDimensionFixed) {
                                ...
                                i8 = getChildMeasureSpec(i2, paddingBottom, layoutParams.height);
                            }
                            view.measure(i7, i8);
                            Metrics metrics = this.mMetrics;
                            if (metrics != null) {
