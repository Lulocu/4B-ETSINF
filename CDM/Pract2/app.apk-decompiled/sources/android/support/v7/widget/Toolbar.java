...
public class Toolbar extends ViewGroup {
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (!shouldLayout(this.mNavButtonView)) {
            ...
            i5 = layoutChildRight(this.mNavButtonView, i20, iArr, min);
            i6 = paddingLeft;
        } else {
        ...
        if (shouldLayout || shouldLayout2) {
            ...
            if (i21 == 48) {
                ...
                i13 = max;
                i14 = (((height - paddingBottom) - layoutParams4.bottomMargin) - this.mTitleMarginBottom) - i8;
            }
            if (z3) {
                if (z2) {
                ...
                if (shouldLayout) {
                    ...
                    this.mTitleTextView.layout(measuredWidth, i14, min2, measuredHeight);
        ...
        int i30 = max;
        for (int i31 = i12; i31 < size; i31++) {
            i30 = layoutChildLeft(this.mTempViews.get(i31), i30, iArr, i10);
        }
        addCustomViewsWithGravity(this.mTempViews, 5);
        int size2 = this.mTempViews.size();
        for (int i32 = i12; i32 < size2; i32++) {
            min2 = layoutChildRight(this.mTempViews.get(i32), min2, iArr, i10);
        }
        addCustomViewsWithGravity(this.mTempViews, 1);
        int viewListMeasuredWidth = getViewListMeasuredWidth(this.mTempViews, iArr);
        int i33 = (i11 + (((i9 - i11) - i7) / 2)) - (viewListMeasuredWidth / 2);
        int i34 = viewListMeasuredWidth + i33;
        if (i33 >= i30) {
            i30 = i34 > min2 ? i33 - (i34 - min2) : i33;
        }
        int size3 = this.mTempViews.size();
        while (i12 < size3) {
            i30 = layoutChildLeft(this.mTempViews.get(i12), i30, iArr, i10);
            i12++;
        }
