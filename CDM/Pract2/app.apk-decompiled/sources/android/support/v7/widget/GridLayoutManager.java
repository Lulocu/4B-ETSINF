...
public class GridLayoutManager extends LinearLayoutManager {
    ...
    public void layoutChunk(RecyclerView.Recycler recycler, RecyclerView.State state, LinearLayoutManager.LayoutState layoutState, LinearLayoutManager.LayoutChunkResult layoutChunkResult) {
        ...
        while (i < this.mSpanCount && layoutState.hasMore(state) && i14 > 0) {
        ...
        for (int i19 = 0; i19 < i; i19++) {
            ...
            if (this.mOrientationHelper.getDecoratedMeasurement(view3) != i16) {
                ...
                if (this.mOrientation == 1) {
                    i12 = getChildMeasureSpec(spaceForSpanRange, 1073741824, i21, layoutParams.width, false);
                    i11 = View.MeasureSpec.makeMeasureSpec(i16 - i20, 1073741824);
                } else {
                    int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(i16 - i21, 1073741824);
                    i11 = getChildMeasureSpec(spaceForSpanRange, 1073741824, i20, layoutParams.height, false);
                    i12 = makeMeasureSpec;
                }
