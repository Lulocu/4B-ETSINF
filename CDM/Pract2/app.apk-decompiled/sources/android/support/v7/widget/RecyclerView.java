    ...
    public class ViewFlinger implements Runnable {
        ...
        public void run() {
            ...
            if (overScroller.computeScrollOffset()) {
                ...
                if (RecyclerView.this.mAdapter != null) {
                    ...
                    if (smoothScroller != null && !smoothScroller.isPendingInitialRun() && smoothScroller.isRunning()) {
                        ...
                        if (itemCount == 0) {
                            ...
                            smoothScroller.onAnimation(i5 - i2, i6 - i);
                        } else {
                            smoothScroller.onAnimation(i5 - i2, i6 - i);
                        }
                    }
                ...
                boolean z = (i5 == 0 && i6 == 0) || (i5 != 0 && RecyclerView.this.mLayout.canScrollHorizontally() && i4 == i5) || (i6 != 0 && RecyclerView.this.mLayout.canScrollVertically() && i3 == i6);
    ...
    public static abstract class LayoutManager {
        ...
        public boolean performAccessibilityAction(@NonNull Recycler recycler, @NonNull State state, int i, @Nullable Bundle bundle) {
            ...
            if (i == 4096) {
                ...
                i2 = this.mRecyclerView.canScrollHorizontally(1) ? (getWidth() - getPaddingLeft()) - getPaddingRight() : 0;
            } else if (i != 8192) {
                i3 = 0;
                i2 = 0;
            } else {
